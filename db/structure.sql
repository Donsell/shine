...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@delzell\.net'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20151201030859');

INSERT INTO schema_migrations (version) VALUES ('20151203151642');

INSERT INTO schema_migrations (version) VALUES ('20151207210624');

INSERT INTO schema_migrations (version) VALUES ('20151214033803');

INSERT INTO schema_migrations (version) VALUES ('20160121120711');

INSERT INTO schema_migrations (version) VALUES ('20160122202107');

INSERT INTO schema_migrations (version) VALUES ('20160123043758');
